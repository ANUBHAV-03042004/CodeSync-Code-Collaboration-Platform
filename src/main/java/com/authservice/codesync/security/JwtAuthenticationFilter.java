...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        // Never intercept OAuth2 login/callback paths — Spring Security's own
        // OAuth2 filters must handle these unmodified. If this filter runs first
        // and touches the request/response, it corrupts the authorization code
        // exchange and causes 401 errors from the provider's token endpoint.
